...
import type { KeyTestResult, NodeConnection, NodeModel, UpstreamNode } from "../api/types";
import { toastApiError } from "../utils/errors";
import { fmtMs } from "../utils/format";
import {
  ArrowLeft, ArrowsClockwise, Check, CheckCircle, DownloadSimple, PencilSimple,
      ...
      <div className="flex flex-wrap items-center gap-2 border-b border-border-subtle p-3">
        ...
        <div className="ml-auto flex items-center gap-2">
          <input
            ...
            className="w-56 rounded-md border border-border-subtle bg-surface-2 px-3 py-1.5 font-mono text-xs text-text-main placeholder:text-text-main/40 focus:outline-none focus:ring-2 focus:ring-accent/40"
          />
      ...
      <table className="w-full">
        ...
        <tbody>
          {models.isLoading ? (
            ...
            rows.map((row) => (
              <tr key={row.id} className="border-b border-border-subtle last:border-0 hover:bg-surface-2/40">
